/*
 ...
 (c) Copyright 2010-2014 DWUser.com, All Rights Reserved
...
if(!(a.liveFired===this||!i||!i.live||a.button&&"click"===a.type)){a.namespace&&(n=RegExp("(^|\\.)"+a.namespace.split(".").join("\\.(?:.*\\.)?")+"(\\.|$)"));a.liveFired=this;var g=i.live.slice(0);for(o=0;o<g.length;o++)i=g[o],i.origType.replace(ta,"")===a.type?m.push(i.selector):g.splice(o--,1);m=b(a.target).closest(m,a.currentTarget);q=0;for(d=m.length;q<d;q++){u=m[q];for(o=0;o<g.length;o++)if(i=g[o],u.selector===i.selector&&(!n||n.test(i.namespace))){w=u.elem;f=null;if("mouseenter"===i.preType||
...
i.events=o={});q||(i.handle=q=function(){return typeof b!=="undefined"&&!b.event.triggered?b.event.handle.apply(q.elem,arguments):j});q.elem=a;for(var c=c.split(" "),u=0,n;w=c[u++];){i=m?b.extend({},m):{handler:e,data:f};-1<w.indexOf(".")?(n=w.split("."),w=n.shift(),i.namespace=n.slice(0).sort().join(".")):(n=[],i.namespace="");i.type=w;i.guid||(i.guid=e.guid);var z=o[w],g=b.event.special[w]||{};if(!z&&(z=o[w]=[],!g.setup||!1===g.setup.call(a,f,n,q)))a.addEventListener?a.addEventListener(w,q,!1):
a.attachEvent&&a.attachEvent("on"+w,q);g.add&&(g.add.call(a,i),i.handler.guid||(i.handler.guid=e.guid));z.push(i);b.event.global[w]=!0}a=null}}},global:{},remove:function(a,c,e,f){if(!(3===a.nodeType||8===a.nodeType)){!1===e&&(e=M);var m,i,w=0,o,q,d,u,n,g,z=a.nodeType?"events":"__events__",k=b.data(a),h=k&&k[z];if(k&&h)if("function"===typeof h&&(k=h,h=h.events),c&&c.type&&(e=c.handler,c=c.type),!c||"string"===typeof c&&"."===c.charAt(0))for(m in c=c||"",h)b.event.remove(a,m+c);else{for(c=c.split(" ");m=
c[w++];)if(u=m,o=0>m.indexOf("."),q=[],o||(q=m.split("."),m=q.shift(),d=RegExp("(^|\\.)"+b.map(q.slice(0).sort(),ja).join("\\.(?:.*\\.)?")+"(\\.|$)")),n=h[m])if(e){u=b.event.special[m]||{};for(i=f||0;i<n.length;i++)if(g=n[i],e.guid===g.guid){if(o||d.test(g.namespace))null==f&&n.splice(i--,1),u.remove&&u.remove.call(a,g);if(null!=f)break}if(0===n.length||null!=f&&1===n.length)(!u.teardown||!1===u.teardown.call(a,q))&&b.removeEvent(a,m,k.handle),delete h[m]}else for(i=0;i<n.length;i++)if(g=n[i],o||
d.test(g.namespace))b.event.remove(a,u,g.handler,i),n.splice(i--,1);if(b.isEmptyObject(h)){if(c=k.handle)c.elem=null;delete k.events;delete k.handle;"function"===typeof k?b.removeData(a,z):b.isEmptyObject(k)&&b.removeData(a)}}}},trigger:function(a,c,e,f){var m=a.type||a;if(!f){a="object"===typeof a?a[b.expando]?a:b.extend(b.Event(m),a):b.Event(m);0<=m.indexOf("!")&&(a.type=m=m.slice(0,-1),a.exclusive=!0);e||(a.stopPropagation(),b.event.global[m]&&b.each(b.cache,function(){this.events&&this.events[m]&&
...
"hover")a.push("mouseenter"+u,"mouseleave"+u);else{q=d;if(d==="focus"||d==="blur"){a.push(z[d]+u);d=d+u}else d=(z[d]||d)+u;if(c==="live"){u=0;for(var g=i.length;u<g;u++)b.event.add(i[u],"live."+G(d,n),{data:f,selector:n,handler:m,origType:d,origHandler:m,preType:q})}else i.unbind("live."+G(d,n),m)}}return this}});b.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error".split(" "),
...
f=0,m=Object.prototype.toString,i=false,d=true;[0,0].sort(function(){d=false;return 0});var o=function(a,c,b,f){var b=b||[],i=c=c||l;if(c.nodeType!==1&&c.nodeType!==9)return[];if(!a||typeof a!=="string")return b;var d,w,n,g,k,h=true,t=o.isXML(c),T=[],Y=a;do{e.exec("");if(d=e.exec(Y)){Y=d[3];T.push(d[1]);if(d[2]){g=d[3];break}}}while(d);if(T.length>1&&u.exec(a))if(T.length===2&&q.relative[T[0]])w=K(T[0]+T[1],c);else for(w=q.relative[T[0]]?[c]:o(T.shift(),c);T.length;){a=T.shift();q.relative[a]&&(a=
a+T.shift());w=K(a,w)}else{if(!f&&T.length>1&&c.nodeType===9&&!t&&q.match.ID.test(T[0])&&!q.match.ID.test(T[T.length-1])){d=o.find(T.shift(),c,t);c=d.expr?o.filter(d.expr,d.set)[0]:d.set[0]}if(c){d=f?{expr:T.pop(),set:z(f)}:o.find(T.pop(),T.length===1&&(T[0]==="~"||T[0]==="+")&&c.parentNode?c.parentNode:c,t);w=d.expr?o.filter(d.expr,d.set):d.set;for(T.length>0?n=z(w):h=false;T.length;){d=k=T.pop();q.relative[k]?d=T.pop():k="";d==null&&(d=c);q.relative[k](n,d,t)}}else n=[]}n||(n=w);n||o.error(k||a);
if(m.call(n)==="[object Array]")if(h)if(c&&c.nodeType===1)for(a=0;n[a]!=null;a++)n[a]&&(n[a]===true||n[a].nodeType===1&&o.contains(c,n[a]))&&b.push(w[a]);else for(a=0;n[a]!=null;a++)n[a]&&n[a].nodeType===1&&b.push(w[a]);else b.push.apply(b,n);else z(n,b);if(g){o(g,i,b,f);o.uniqueSort(b)}return b};o.uniqueSort=function(a){if(h){i=d;a.sort(h);if(i)for(var c=1;c<a.length;c++)a[c]===a[c-1]&&a.splice(c--,1)}return a};o.matches=function(a,c){return o(a,null,null,c)};o.matchesSelector=function(a,c){return o(c,
...
null&&f[2]){var g,z,k=q.filter[u];z=f[1];i=false;f.splice(1,1);if(z.substr(z.length-1)!=="\\"){n===d&&(d=[]);if(q.preFilter[u])if(f=q.preFilter[u](f,n,b,d,e,w)){if(f===true)continue}else i=g=true;if(f)for(var h=0;(z=n[h])!=null;h++)if(z){g=k(z,f,h,n);var T=e^!!g;if(b&&g!=null)T?i=true:n[h]=false;else if(T){d.push(z);i=true}}if(g!==j){b||(n=d);a=a.replace(q.match[u],"");if(!i)return[];break}}}if(a===m)if(i==null)o.error(a);else break;m=a}return n};o.error=function(a){throw"Syntax error, unrecognized expression: "+
...
a.getAttribute(b),e=b+"",f=c[2],i=c[4];return b==null?f==="!=":f==="="?e===i:f==="*="?e.indexOf(i)>=0:f==="~="?(" "+e+" ").indexOf(i)>=0:!i?e&&b!==false:f==="!="?e!==i:f==="^="?e.indexOf(i)===0:f==="$="?e.substr(e.length-i.length)===i:f==="|="?e===i||e.substr(0,i.length+1)===i+"-":false},POS:function(a,c,b,e){var f=q.setFilters[c[2]];if(f)return f(a,b,c,e)}}},u=q.match.POS,n=function(a,c){return"\\"+(c-0+1)},g;for(g in q.match){q.match[g]=RegExp(q.match[g].source+/(?![^\[]*\])(?![^\(]*\))/.source);
q.leftMatch[g]=RegExp(/(^(?:.|\r|\n)*?)/.source+q.match[g].source.replace(/\\(\d+)/g,n))}var z=function(a,c){a=Array.prototype.slice.call(a,0);if(c){c.push.apply(c,a);return c}return a};try{Array.prototype.slice.call(l.documentElement.childNodes,0)}catch(k){z=function(a,c){var b=0,e=c||[];if(m.call(a)==="[object Array]")Array.prototype.push.apply(e,a);else if(typeof a.length==="number")for(var f=a.length;b<f;b++)e.push(a[b]);else for(;a[b];b++)e.push(a[b]);return e}}var h,t;if(l.documentElement.compareDocumentPosition)h=
function(a,c){if(a===c){i=true;return 0}return!a.compareDocumentPosition||!c.compareDocumentPosition?a.compareDocumentPosition?-1:1:a.compareDocumentPosition(c)&4?-1:1};else{h=function(a,c){var b,e,f=[],m=[];b=a.parentNode;e=c.parentNode;var d=b;if(a===c){i=true;return 0}if(b===e)return t(a,c);if(b){if(!e)return 1}else return-1;for(;d;){f.unshift(d);d=d.parentNode}for(d=e;d;){m.unshift(d);d=d.parentNode}b=f.length;e=m.length;for(d=0;d<b&&d<e;d++)if(f[d]!==m[d])return t(f[d],m[d]);return d===b?t(a,
...
"find",a),e=0,f=0,m=this.length;f<m;f++){e=c.length;b.find(a,this[f],c);if(f>0)for(var i=e;i<c.length;i++)for(var d=0;d<e;d++)if(c[d]===c[i]){c.splice(i--,1);break}}return c},has:function(a){var c=b(a);return this.filter(function(){for(var a=0,f=c.length;a<f;a++)if(b.contains(this,c[a]))return true})},not:function(a){return this.pushStack(g(this,a,false),"not",a)},filter:function(a){return this.pushStack(g(this,a,true),"filter",a)},is:function(a){return!!a&&b.filter(a,this).length>0},closest:function(a,
...
g=c.createElement("div");for(g.innerHTML=q[1]+n+q[2];u--;)g=g.lastChild;if(!b.support.tbody){u=Ja.test(n);o=o==="table"&&!u?g.firstChild&&g.firstChild.childNodes:q[1]==="<table>"&&!u?g.childNodes:[];for(q=o.length-1;q>=0;--q)b.nodeName(o[q],"tbody")&&!o[q].childNodes.length&&o[q].parentNode.removeChild(o[q])}!b.support.leadingWhitespace&&oa.test(n)&&g.insertBefore(c.createTextNode(oa.exec(n)[0]),g.firstChild);n=g.childNodes}n.nodeType?d.push(n):d=b.merge(d,n)}}if(e)for(i=0;d[i];i++)if(f&&b.nodeName(d[i],
...
a;b.handleSuccess(c,t,f,m);b.handleComplete(c,t,f,m);g&&g.removeChild(z)}}if(c.dataType==="script"&&c.cache===null)c.cache=false;if(c.cache===false&&n){var q=b.now(),u=c.url.replace(K,"$1_="+q);c.url=u+(u===c.url?(ea.test(c.url)?"&":"?")+"_="+q:"")}if(c.data&&n)c.url=c.url+((ea.test(c.url)?"&":"?")+c.data);c.global&&b.active++===0&&b.event.trigger("ajaxStart");q=(q=aa.exec(c.url))&&(q[1]&&q[1].toLowerCase()!==location.protocol||q[2].toLowerCase()!==location.host);if(c.dataType==="script"&&i==="GET"&&
q){var g=l.getElementsByTagName("head")[0]||l.documentElement,z=l.createElement("script");if(c.scriptCharset)z.charset=c.scriptCharset;z.src=c.url;if(!e){var k=false;z.onload=z.onreadystatechange=function(){if(!k&&(!this.readyState||this.readyState==="loaded"||this.readyState==="complete")){k=true;b.handleSuccess(c,t,f,m);b.handleComplete(c,t,f,m);z.onload=z.onreadystatechange=null;g&&z.parentNode&&g.removeChild(z)}}}g.insertBefore(z,g.firstChild);return j}var h=false,t=c.xhr();if(t){c.username?t.open(i,
...
c.beforeSend.call(c.context,t,c)===false){c.global&&b.active--===1&&b.event.trigger("ajaxStop");t.abort();return false}c.global&&b.triggerGlobal(c,"ajaxSend",[t,c]);var C=t.onreadystatechange=function(a){if(!t||t.readyState===0||a==="abort"){h||b.handleComplete(c,t,f,m);h=true;if(t)t.onreadystatechange=b.noop}else if(!h&&t&&(t.readyState===4||a==="timeout")){h=true;t.onreadystatechange=b.noop;f=a==="timeout"?"timeout":!b.httpSuccess(t)?"error":c.ifModified&&b.httpNotModified(t,c.url)?"notmodified":
"success";var d;if(f==="success")try{m=b.httpData(t,c.dataType,c)}catch(i){f="parsererror";d=i}f==="success"||f==="notmodified"?e||b.handleSuccess(c,t,f,m):b.handleError(c,t,f,d);e||b.handleComplete(c,t,f,m);a==="timeout"&&t.abort();c.async&&(t=null)}};try{var p=t.abort;t.abort=function(){t&&Function.prototype.call.call(p,t);C("abort")}}catch(Aa){}c.async&&c.timeout>0&&setTimeout(function(){t&&!h&&C("timeout")},c.timeout);try{t.send(n||c.data==null?null:c.data)}catch(E){b.handleError(c,t,null,E);
...
if($a.test(f))d[f==="toggle"?q?"show":"hide":f](a);else{var m=x.exec(f),o=d.cur()||0;if(m){var u=parseFloat(m[2]),g=m[3]||"px";if(g!=="px"){b.style(n,e,(u||1)+g);o=(u||1)/d.cur()*o;b.style(n,e,o+g)}m[1]&&(u=(m[1]==="-="?-1:1)*u+o);d.custom(o,u,g)}else d.custom(o,f,"")}});return true})},stop:function(a,c){var e=b.timers;a&&this.queue([]);this.each(function(){for(var a=e.length-1;a>=0;a--)if(e[a].elem===this){c&&e[a](true);e.splice(a,1)}});c||this.dequeue();return this}});b.each({slideDown:v("show",
...
var er_swfobject22=function(){function d(){if(!ca){try{var b=s.getElementsByTagName("body")[0].appendChild(s.createElement("span"));b.parentNode.removeChild(b)}catch(d){return}ca=!0;for(var b=za.length,g=0;g<b;g++)za[g]()}}function j(b){ca?b():za[za.length]=b}function y(b){if(typeof W.addEventListener!=F)W.addEventListener("load",b,!1);else if(typeof s.addEventListener!=F)s.addEventListener("load",b,!1);else if(typeof W.attachEvent!=F)v(W,"onload",b);else if("function"==typeof W.onload){var d=W.onload;
W.onload=function(){d();b()}}else W.onload=b}function M(){var b=s.getElementsByTagName("body")[0],d=s.createElement(fa);d.setAttribute("type",ga);var g=b.appendChild(d);if(g){var k=0;(function(){if(typeof g.GetVariable!=F){var h=g.GetVariable("$version");h&&(h=h.split(" ")[1].split(","),r.pv=[parseInt(h[0],10),parseInt(h[1],10),parseInt(h[2],10)])}else if(10>k){k++;setTimeout(arguments.callee,10);return}b.removeChild(d);g=null;la()})()}else la()}function la(){var b=pa.length;if(0<b)for(var d=0;d<
b;d++){var h=pa[d].id,k=pa[d].callbackFn,j={success:!1,id:h};if(0<r.pv[0]){var I=D(h);if(I)if(N(pa[d].swfVersion)&&!(r.wk&&312>r.wk))l(h,!0),k&&(j.success=!0,j.ref=p(h),k(j));else if(pa[d].expressInstall&&ia()){j={};j.data=pa[d].expressInstall;j.width=I.getAttribute("width")||"0";j.height=I.getAttribute("height")||"0";I.getAttribute("class")&&(j.styleclass=I.getAttribute("class"));I.getAttribute("align")&&(j.align=I.getAttribute("align"));for(var P={},I=I.getElementsByTagName("param"),A=I.length,
s=0;s<A;s++)"movie"!=I[s].getAttribute("name").toLowerCase()&&(P[I[s].getAttribute("name")]=I[s].getAttribute("value"));G(j,P,h,k)}else g(I),k&&k(j)}else if(l(h,!0),k){if((h=p(h))&&typeof h.SetVariable!=F)j.success=!0,j.ref=h;k(j)}}}function p(b){var d=null;if((b=D(b))&&"OBJECT"==b.nodeName)if(typeof b.SetVariable!=F)d=b;else if(b=b.getElementsByTagName(fa)[0])d=b;return d}function ia(){return!ma&&N("6.0.65")&&(r.win||r.mac)&&!(r.wk&&312>r.wk)}function G(b,d,g,l){ma=!0;Fa=l||null;ja={success:!1,id:g};
var j=D(g);if(j){"OBJECT"==j.nodeName?(B=h(j),ya=null):(B=j,ya=g);b.id=ua;if(typeof b.width==F||!/%$/.test(b.width)&&310>parseInt(b.width,10))b.width="310";if(typeof b.height==F||!/%$/.test(b.height)&&137>parseInt(b.height,10))b.height="137";s.title=s.title.slice(0,47)+" - Flash Player Installation";l=r.ie&&r.win?"ActiveX":"PlugIn";l="MMredirectURL="+encodeURI(W.location).toString().replace(/&/g,"%26")+"&MMplayerType="+l+"&MMdoctitle="+s.title;d.flashvars=typeof d.flashvars!=F?d.flashvars+("&"+l):
l;r.ie&&(r.win&&4!=j.readyState)&&(l=s.createElement("div"),g+="SWFObjectNew",l.setAttribute("id",g),j.parentNode.insertBefore(l,j),j.style.display="none",function(){j.readyState==4?j.parentNode.removeChild(j):setTimeout(arguments.callee,10)}());k(b,d,g)}}function g(b){if(r.ie&&r.win&&4!=b.readyState){var d=s.createElement("div");b.parentNode.insertBefore(d,b);d.parentNode.replaceChild(h(b),d);b.style.display="none";(function(){4==b.readyState?b.parentNode.removeChild(b):setTimeout(arguments.callee,
10)})()}else b.parentNode.replaceChild(h(b),b)}function h(b){var d=s.createElement("div");if(r.win&&r.ie)d.innerHTML=b.innerHTML;else if(b=b.getElementsByTagName(fa)[0])if(b=b.childNodes)for(var g=b.length,h=0;h<g;h++)!(1==b[h].nodeType&&"PARAM"==b[h].nodeName)&&8!=b[h].nodeType&&d.appendChild(b[h].cloneNode(!0));return d}function k(b,d,g){var h,k=D(g);if(r.wk&&312>r.wk)return h;if(k)if(typeof b.id==F&&(b.id=g),r.ie&&r.win){var l="",j;for(j in b)b[j]!=Object.prototype[j]&&("data"==j.toLowerCase()?
...
p.toLowerCase()&&I.setAttribute(p,b[p]));for(l in d)d[l]!=Object.prototype[l]&&"movie"!=l.toLowerCase()&&(b=I,j=l,p=d[l],g=s.createElement("param"),g.setAttribute("name",j),g.setAttribute("value",p),b.appendChild(g));k.parentNode.replaceChild(I,k);h=I}return h}function P(b){var d=D(b);d&&"OBJECT"==d.nodeName&&(r.ie&&r.win?(d.style.display="none",function(){if(4==d.readyState){var g=D(b);if(g){for(var h in g)"function"==typeof g[h]&&(g[h]=null);g.parentNode.removeChild(g)}}else setTimeout(arguments.callee,
10)}()):d.parentNode.removeChild(d))}function D(b){var d=null;try{d=s.getElementById(b)}catch(g){}return d}function v(b,d,g){b.attachEvent(d,g);ra[ra.length]=[b,d,g]}function N(b){var d=r.pv,b=b.split(".");b[0]=parseInt(b[0],10);b[1]=parseInt(b[1],10)||0;b[2]=parseInt(b[2],10)||0;return d[0]>b[0]||d[0]==b[0]&&d[1]>b[1]||d[0]==b[0]&&d[1]==b[1]&&d[2]>=b[2]?!0:!1}function A(b,d,g,h){if(!r.ie||!r.mac){var k=s.getElementsByTagName("head")[0];if(k){g=g&&"string"==typeof g?g:"screen";h&&(ka=J=null);if(!J||
ka!=g)h=s.createElement("style"),h.setAttribute("type","text/css"),h.setAttribute("media",g),J=k.appendChild(h),r.ie&&(r.win&&typeof s.styleSheets!=F&&0<s.styleSheets.length)&&(J=s.styleSheets[s.styleSheets.length-1]),ka=g;r.ie&&r.win?J&&typeof J.addRule==fa&&J.addRule(b,d):J&&typeof s.createTextNode!=F&&J.appendChild(s.createTextNode(b+" {"+d+"}"))}}}function l(b,d){if(V){var g=d?"visible":"hidden";ca&&D(b)?D(b).style.visibility=g:A("#"+b,"visibility:"+g)}}function b(b){return null!=/[\\\"<>\.;]/.exec(b)&&
typeof encodeURIComponent!=F?encodeURIComponent(b):b}var F="undefined",fa="object",ga="application/x-shockwave-flash",ua="SWFObjectExprInst",W=window,s=document,$=navigator,I=!1,za=[function(){I?M():la()}],pa=[],ta=[],ra=[],B,ya,Fa,ja,ca=!1,ma=!1,J,ka,V=!0,r=function(){var b=typeof s.getElementById!=F&&typeof s.getElementsByTagName!=F&&typeof s.createElement!=F,d=$.userAgent.toLowerCase(),g=$.platform.toLowerCase(),h=g?/win/.test(g):/win/.test(d),g=g?/mac/.test(g):/mac/.test(d),d=/webkit/.test(d)?
...
F)try{var p=new ActiveXObject("ShockwaveFlash.ShockwaveFlash");if(p&&(j=p.GetVariable("$version")))k=!0,j=j.split(" ")[1].split(","),l=[parseInt(j[0],10),parseInt(j[1],10),parseInt(j[2],10)]}catch(P){}return{w3:b,pv:l,wk:d,ie:k,win:h,mac:g}}();(function(){r.w3&&((typeof s.readyState!=F&&"complete"==s.readyState||typeof s.readyState==F&&(s.getElementsByTagName("body")[0]||s.body))&&d(),ca||(typeof s.addEventListener!=F&&s.addEventListener("DOMContentLoaded",d,!1),r.ie&&r.win&&(s.attachEvent("onreadystatechange",
...
for(var g in r)r[g]=null;r=null;for(var h in er_swfobject22)er_swfobject22[h]=null;er_swfobject22=null})})();return{registerObject:function(b,d,g,h){if(r.w3&&b&&d){var k={};k.id=b;k.swfVersion=d;k.expressInstall=g;k.callbackFn=h;pa[pa.length]=k;l(b,!1)}else h&&h({success:!1,id:b})},getObjectById:function(b){if(r.w3)return p(b)},embedSWF:function(b,d,g,h,I,p,P,D,s,A){var v={success:!1,id:d};r.w3&&!(r.wk&&312>r.wk)&&b&&d&&g&&h&&I?(l(d,!1),j(function(){g+="";h+="";var j={};if(s&&typeof s===fa)for(var r in s)j[r]=
s[r];j.data=b;j.width=g;j.height=h;r={};if(D&&typeof D===fa)for(var B in D)r[B]=D[B];if(P&&typeof P===fa)for(var y in P)r.flashvars=typeof r.flashvars!=F?r.flashvars+("&"+y+"="+P[y]):y+"="+P[y];if(N(I))B=k(j,r,d),j.id==d&&l(d,!0),v.success=!0,v.ref=B;else{if(p&&ia()){j.data=p;G(j,r,d,A);return}l(d,!0)}A&&A(v)})):A&&A(v)},switchOffAutoHideShow:function(){V=!1},ua:r,getFlashPlayerVersion:function(){return{major:r.pv[0],minor:r.pv[1],release:r.pv[2]}},hasFlashPlayerVersion:N,createSWF:function(b,d,g){if(r.w3)return k(b,
d,g)},showExpressInstall:function(b,d,g,h){r.w3&&ia()&&G(b,d,g,h)},removeSWF:function(b){r.w3&&P(b)},createCSS:function(b,d,g,h){r.w3&&A(b,d,g,h)},addDomLoadEvent:j,addLoadEvent:y,getQueryParamValue:function(d){var g=s.location.search||s.location.hash;if(g){/\?/.test(g)&&(g=g.split("?")[1]);if(null==d)return b(g);for(var g=g.split("&"),h=0;h<g.length;h++)if(g[h].substring(0,g[h].indexOf("="))==d)return b(g[h].substring(g[h].indexOf("=")+1))}return""},expressInstallCallback:function(){if(ma){var b=
D(ua);b&&B&&(b.parentNode.replaceChild(B,b),ya&&(l(ya,!0),r.ie&&r.win&&(B.style.display="block")),Fa&&Fa(ja));ma=!1}}}}(),er_$f=function(d){function j(d){return new j.fn.init(d)}function y(g,h,k){if(!k.contentWindow.postMessage)return!1;var j=k.getAttribute("src").split("?")[0],g=JSON.stringify({method:g,value:h});"//"===j.substr(0,2)&&(j=d.location.protocol+j);k.contentWindow.postMessage(g,j)}function M(d){var h,k;try{h=JSON.parse(d.data),k=h.event||h.method}catch(j){}"ready"==k&&!ia&&(ia=!0);if(d.origin!=
G)return!1;var d=h.value,D=h.data,v=""===v?null:h.player_id;h=v?p[v][k]:p[k];k=[];if(!h)return!1;void 0!==d&&k.push(d);D&&k.push(D);v&&k.push(v);return 0<k.length?h.apply(null,k):h.call()}function la(d,h,k){k?(p[k]||(p[k]={}),p[k][d]=h):p[d]=h}var p={},ia=!1,G="";j.fn=j.prototype={element:null,init:function(g){"string"===typeof g&&(g=document.getElementById(g));this.element=g;g=this.element.getAttribute("src");"//"===g.substr(0,2)&&(g=d.location.protocol+g);for(var g=g.split("/"),h="",k=0,j=g.length;k<
j;k++){if(3>k)h+=g[k];else break;2>k&&(h+="/")}G=h;return this},api:function(d,h){if(!this.element||!d)return!1;var k=this.element,j=""!==k.id?k.id:null,p=!h||!h.constructor||!h.call||!h.apply?h:null,v=h&&h.constructor&&h.call&&h.apply?h:null;v&&la(d,v,j);y(d,p,k);return this},addEvent:function(d,h){if(!this.element)return!1;var k=this.element,j=""!==k.id?k.id:null;la(d,h,j);"ready"!=d?y("addEventListener",d,k):"ready"==d&&ia&&h.call(null,j);return this},removeEvent:function(d){if(!this.element)return!1;
var h=this.element,k=""!==h.id?h.id:null;a:{if(k&&p[k]){if(!p[k][d]){k=!1;break a}p[k][d]=null}else{if(!p[d]){k=!1;break a}p[d]=null}k=!0}"ready"!=d&&k&&y("removeEventListener",d,h)}};j.fn.init.prototype=j.fn;d.addEventListener?d.addEventListener("message",M,!1):d.attachEvent("onmessage",M);return j}(window);
(function(d,j,y,M,la,p){if("undefined"===typeof y.erO1I){y.erO1I=1;d&&function(){d.extend(d.fn,{contextMenu:function(g,h){if(void 0==g.menu)return!1;void 0==g.inSpeed&&(g.inSpeed=150);void 0==g.outSpeed&&(g.outSpeed=75);0==g.inSpeed&&(g.inSpeed=-1);0==g.outSpeed&&(g.outSpeed=-1);d(this).each(function(){var k=d(this),p=d(k).offset();d("#"+g.menu).addClass("contextMenu");d(this).mousedown(function(D){if(D.button==2){D.stopPropagation();d(this).mouseup(function(v){v.stopPropagation();var N=d(this);d(this).unbind(v);
if(D.button==2){d(".contextMenu").hide();var A=d("#"+g.menu);if(d(k).hasClass("disabled"))return false;var l,b;v.pageX?l=v.pageX:l=v.clientX+void 0;v.pageY?b=v.pageY:b=v.clientY+void 0;d(j).unbind("click");d(A).css({top:b,left:l}).fadeIn(g.inSpeed);d(A).find("A").mouseover(function(){d(A).find("LI.hover").removeClass("hover");d(this).parent().addClass("hover")}).mouseout(function(){d(A).find("LI.hover").removeClass("hover")});d(j).keypress(function(b){switch(b.keyCode){case 38:if(d(A).find("LI.hover").size()==
...
break;case 27:d(j).trigger("click")}});d("#"+g.menu).find("A").unbind("click");d("#"+g.menu).find("LI:not(.disabled) A").click(function(){d(j).unbind("click").unbind("keypress");d(".contextMenu").hide();h&&h(d(this).attr("href").substr(1),d(N),{x:l-p.left,y:b-p.top,docX:l,docY:b});return false});setTimeout(function(){d(j).click(function(){d(j).unbind("click").unbind("keypress");d(A).fadeOut(g.outSpeed);return false})},0)}})}});d.browser.mozilla?d("#"+g.menu).each(function(){d(this).css({MozUserSelect:"none"})}):
d.browser.msie?d("#"+g.menu).each(function(){d(this).bind("selectstart.disableTextSelect",function(){return false})}):d("#"+g.menu).each(function(){d(this).bind("mousedown.disableTextSelect",function(){return false})});d(k).add(d("UL.contextMenu")).bind("contextmenu",function(){return false})});return d(this)},disableContextMenuItems:function(g){if(void 0==g)return d(this).find("LI").addClass("disabled"),d(this);d(this).each(function(){if(void 0!=g)for(var h=g.split(","),k=0;k<h.length;k++)d(this).find('A[href="'+
h[k]+'"]').parent().addClass("disabled")});return d(this)},enableContextMenuItems:function(g){if(void 0==g)return d(this).find("LI.disabled").removeClass("disabled"),d(this);d(this).each(function(){if(void 0!=g)for(var h=g.split(","),k=0;k<h.length;k++)d(this).find('A[href="'+h[k]+'"]').parent().removeClass("disabled")});return d(this)},disableContextMenu:function(){d(this).each(function(){d(this).addClass("disabled")});return d(this)},enableContextMenu:function(){d(this).each(function(){d(this).removeClass("disabled")});
return d(this)},destroyContextMenu:function(){d(this).each(function(){d(this).unbind("mousedown").unbind("mouseup")});return d(this)}})}(d);(function(d){function h(h){var k=h||y.event,j=[].slice.call(arguments,1),p=0,A=0,l=0,h=d.event.fix(k);h.type="mousewheel";h.wheelDelta&&(p=h.wheelDelta/120);h.detail&&(p=-h.detail/3);l=p;void 0!==k.axis&&k.axis===k.HORIZONTAL_AXIS&&(l=0,A=-1*p);void 0!==k.wheelDeltaY&&(l=k.wheelDeltaY/120);void 0!==k.wheelDeltaX&&(A=-1*k.wheelDeltaX/120);j.unshift(h,p,A,l);return d.event.handle.apply(this,
j)}var k=["DOMMouseScroll","mousewheel"];d.event.special.mousewheel={setup:function(){if(this.addEventListener)for(var d=k.length;d;)this.addEventListener(k[--d],h,!1);else this.onmousewheel=h},teardown:function(){if(this.removeEventListener)for(var d=k.length;d;)this.removeEventListener(k[--d],h,!1);else this.onmousewheel=null}};d.fn.extend({mousewheel:function(d){return d?this.bind("mousewheel",d):this.trigger("mousewheel")},unmousewheel:function(d){return this.unbind("mousewheel",d)}})})(d);(function(d){d.fn.iosSwipe=
function(h){var k={dimension:"x",threshold:{x:30,tolerance:0.5},killEvents:!0,swipe:function(){}},h=d.extend(k,h);return!this?!1:this.each(function(){var h,j,v,N;function A(b){k.killEvents&&b.preventDefault();h=b.targetTouches[0].pageX;j=b.targetTouches[0].pageY}function l(){var b=v-j,d=N-h,g=p.abs(d),l=p.abs(b);k.dimension=="x"?g>k.threshold.x&&l<g*k.threshold.tolerance&&k.swipe(d>0):l>k.threshold.x&&g<l*k.threshold.tolerance&&k.swipe(b>0)}function b(b){N=b.targetTouches[0].pageX;v=b.targetTouches[0].pageY;
h=N;j=v}function y(){}d(this);j=h=v=N=0;try{this.addEventListener("touchstart",b,false);this.addEventListener("touchmove",A,false);this.addEventListener("touchend",l,false);this.addEventListener("touchcancel",y,false)}catch(M){}})}})(d);var ia=function(){function d(g){if(j.all&&!y[g])for(var h=0;h<j.forms.length;h++)if(j.forms[h][g])return j.forms[h][g];return j.all?y[g]:j[g]}var h=[],k,p="",D={},v=-1;return{determineFlashSupport:function(){return M.hasFlashPlayerVersion("9")},setup:function(d,g){p=
d;D=g;M.hasFlashPlayerVersion("9")&&M.createCSS("p.audioplayer_container span","visibility:hidden;height:24px;overflow:hidden;padding:0;border:none;")},getPlayer:function(h){return d(h)},addListener:function(h,k,j){d(h).addListener(k,j)},embed:function(d,g){var k={},b,j={};D.enableCallbacks&&(j.allowScriptAccess="always");var v={},y={};for(b in D)k[b]=D[b];for(b in g)k[b]=g[b];"yes"==k.transparentpagebg?(j.bgcolor="#FFFFFF",j.wmode="transparent"):(k.pagebg&&(j.bgcolor="#"+k.pagebg),j.wmode="opaque");
j.menu="false";for(b in k)"pagebg"==b||("width"==b||"transparentpagebg"==b)||(v[b]=k[b]);y.name=d;y.style="outline: none";v.playerID=d;M.embedSWF(p,d,k.width.toString(),"24","9",g.expressInstall||!1,v,j,y);h.push(d)},syncVolumes:function(k,j){v=j;for(var l=0;l<h.length;l++)h[l]!=k&&d(h[l]).setVolume(v)},activate:function(h){k&&k!=h&&d(k).close();k=h},load:function(h,k,j,b){d(h).load(k,j,b)},close:function(h){d(h).close();h==k&&(k=null)},open:function(h,k){void 0==k&&(k=1);d(h).open(void 0==k?0:k-
1)},getVolume:function(){return v}}}();d.extend(d.easing,{def:"easeOutQuad",swing:function(g,h,k,j,p){return d.easing[d.easing.def](g,h,k,j,p)},easeInQuad:function(d,h,k,j,p){return j*(h/=p)*h+k},easeOutQuad:function(d,h,k,j,p){return-j*(h/=p)*(h-2)+k},easeInOutQuad:function(d,h,k,j,p){return 1>(h/=p/2)?j/2*h*h+k:-j/2*(--h*(h-2)-1)+k},easeInCubic:function(d,h,k,j,p){return j*(h/=p)*h*h+k},easeOutCubic:function(d,h,k,j,p){return j*((h=h/p-1)*h*h+1)+k},easeInExpo:function(d,h,k,j,y){return 0==h?k:j*
p.pow(2,10*(h/y-1))+k},easeOutExpo:function(d,h,k,j,y){return h==y?k+j:j*(-p.pow(2,-10*h/y)+1)+k},easeInOutExpo:function(d,h,k,j,y){return 0==h?k:h==y?k+j:1>(h/=y/2)?j/2*p.pow(2,10*(h-1))+k:j/2*(-p.pow(2,-10*--h)+2)+k}});d.extend(d.fn,{er_cssValueObj:function(d){for(var h={},j=0;j<d.length;j++)h[d[j]]=this.css(d[j]);return h},er_cssPositionToNumber:function(g){g=d(this[0]).css(g);return void 0==g||null==g||"auto"==g?0:!isNaN(Number(g.split("px").join("")))?Number(g.split("px").join("")):0},er_x:function(d){return 1>
arguments.length?this.er_cssPositionToNumber("left"):this.css({left:d})},er_y:function(d){return 1>arguments.length?this.er_cssPositionToNumber("top"):this.css({top:d})},er_cssWidth:function(d){return 1>arguments.length?this.er_cssPositionToNumber("width"):this.css({width:d})},er_cssHeight:function(d){return 1>arguments.length?this.er_cssPositionToNumber("height"):this.css({height:d})},er_alpha:function(d){return 1==arguments.length?this.css({opacity:d}):this.css("opacity")},er_randomize:function(g){return this.each(function(){var h=
d(this),j=h.children(g);j.sort(function(){return p.round(p.random())-0.5});h.children().remove(g);h.append(j)})},er_extendDataObject:function(g,h){return this.each(function(){var j=d(this),p=j.data(g)||{},p=d.extend(p,h);j.data(g,p)})},er_cloneDataObject:function(g){return this.each(function(){var h=d(this),j=h.data(g);j&&h.data(g,d.extend({},j))})}});d.fn.er_opacity=d.fn.er_alpha;var G=function(){d(y.er_preprocessCallbacks).each(function(){this.call(null,d)});var g="http://";try{"https:"==j.location.protocol&&
(g="https://")}catch(h){}var k="ontouchstart"in y,P=/AdobeAIR/i.test(navigator.userAgent),D=!1,v=[],N={dotBlack35:"dots/export/20_14_black_35.png",dotBlack65:"dots/export/20_14_black_65.png",dotWhite35:"dots/export/20_14_wite_35.png",dotWhite65:"dots/export/20_14_wite_65.png",vlbCloseUp:"video/x_up_export.png",vlbCloseOver:"video/x_over_export.png",videoPlayOverlay:"video/play_overlay.png"},A=g+"easyrotator.s3.amazonaws.com/1/i/rotator/",l={},b;for(b in N)l[b]=A+N[b];var N=l,F={circleSmall:"circle_small_%L_%U_export.png",
...
else if(!h&&"translate.googleusercontent.com"!=j.location.hostname&&!b.find("]kniltuobare#=$ferh[a tuobare. ,)]wollofon=*ler[(ton:]/moc.resuwd.www//:ptth=^ferh[a tuobare.".split("").reverse().join(""))[0])confirm("There's a conflict that's breaking your EasyRotator code; please click OK to learn how to address the problem.")&&(y.location="http://www.dwuser.com/support/easyrotator/kb/code-corruption/");else{var l=b.find(".erabout").css({position:"absolute",left:10,top:10}).hide();l.find("a.erabout_ok").click(function(b){b.preventDefault();
l.hide()});l.find("a[href$=#eraboutlink]").click(function(b){b.preventDefault();y.open("http://www.dwuser.com/easyrotator/")});l.find("a").css({border:"none !important",fontWeight:"normal !important",textDecoration:"underline !important"});var A="er_"+(p.random()+"").split(".").join("")+"_cm",F=d('<ul id="'+A+'" class="er_cm" style="display: none;"><li wasclass="separator"><a href="#about">About Rotator...</a></li></ul>');d("body").append(F);h||b.contextMenu({menu:A},function(n){/about$/.test(n)&&
...
k){var p=g,k=p+("http://"==p?"erpv.dwuser.com":"dwuser.com")+"/easyrotator/updates/pcisvc.php?d="+k+"&if="+(u?"y":"n")+"&l="+escape(location.host+location.pathname)+"&nocache="+(new Date).getTime()+"&jsoncallback=?";d.getJSON(k,function(d){d&&"n"===d.v&&(d=h?"You have disabled the right-click menu (a Pro feature)":"You are using EasyRotator Pro features"+(n?" ("+n+")":""),d=u?"You are using EasyRotator Pro features, but EasyRotator Pro features cannot be used in cross-domain iframes.  View the rotator page directly, or contact support for more information.":
d+", but EasyRotator Pro hasn't been enabled for this domain ("+j.domain+').<br /><a style="color: #FFF; text-decoration: underline;" href="http://www.dwuser.com/easyrotator/pro-needed/?d='+j.domain+'" target="_blank">Learn More and Fix...</a>',b.css({padding:30,backgroundColor:"#000",fontFamily:"Georgia,'Times New Roman',Times,_serif",fontSize:16,color:"#FFF",textAlign:"center"}).html(d))})}}};h&&ja();var ca=[];b.is(":hidden")&&b.parents().each(function(){var b=d(this);"none"==(b.css("display")||
"unknown").toLowerCase()&&ca.push(b.css("display",""))});var ma=0<ca.length;W(b);b.er_extendDataObject("er_lRDim",{w:b.width(),h:b.height(),v:!ma});var J=function(d){b.trigger("er_playPause",{v:d})},ka;(function(){var n={src:"easyrotatorvideo.s3.amazonaws.com/1/StrobeMediaPlayback.swf",srcEI:"easyrotatorvideo.s3.amazonaws.com/1/expressInstall.swf",restartAutoplay:!1,showTransparentOverlay:!0},h;for(h in n)void 0!==B["video_"+h]&&(n[h]=B["video_"+h]),/^src/.test(h)&&(n[h]=g+n[h]);var k=!0===B.autoplayAfterVideo;
if(""==j.domain&&B.lpp){var l="";(function(){for(var b=B.lpp.split("-"),d=0;d<b.length;d++)l+=String.fromCharCode(b[d])})();for(h in n)if(/^src/.test(h)){var da=n[h],da=da.substr(da.lastIndexOf("/")+1);n[h]=l+da}}var C=function(b){if(!/^https?:/i.test(b)){var d=function(b){var d=j.location.href,n=d.indexOf("?");-1!=n&&(d=d.substr(0,n));var d=d.substr(0,d.lastIndexOf("/")+1),n=d.replace(/^[^:]+:\/+/,""),d=d.substr(0,d.length-n.length),h=n.indexOf("/");for(/^\//.test(b)&&-1!=h&&(n=n.substr(0,h));"../"==
...
h,g,u){var j=b.find("[data-ertype=vlb]"),k,l;if(0==j.length){j=d('<div data-ertype="vlb" style="position:absolute;left:0;right:0;top:0;bottom:0;background:rgba(50,50,50,0.85);"></div>');j.er_alpha(0).css({"-moz-transition":"opacity 0.3s ease-out","-webkit-transition":"opacity 0.3s ease-out","-o-transition":"opacity 0.3s ease-out",transition:"opacity 0.3s ease-out"});j.appendTo(b);k=d('<div class="erVLBoh" style="position:absolute;left:50%;top:50%;overflow:visible;background:#FFF;-webkit-box-shadow:0 2px 15px rgba(0,0,0,0.7);-moz-box-shadow:0 2px 15px rgba(0,0,0,0.7);box-shadow:0 2px 15px rgba(0,0,0,0.7);"></div>');
...
Y=da.attr("ersrc-up"),C=da.attr("ersrc-over");H.bind("mouseenter touchstart",function(){da[0].src=C}).bind("mouseleave touchend touchcancel",function(){da[0].src=Y}).click(function(){s(j,j.find("div.erVLBmh"))})}var H="-"+p.round(12+n/2)+"px",r="-"+p.round(12+h/2)+"px";k.css({width:n+24,height:h+24,marginLeft:H,marginTop:r});l.css({width:n,height:h});l.hide();setTimeout(function(){j.er_alpha(1)},1);setTimeout(function(){l.show()},310);l.html(g);u(l)},z={},xa="ervBridgeCB"+(p.random()+"").substr(2);
y[xa]=function(d){if(!z[d]){z[d]=1;try{var n,h=M.getObjectById(d);n=xa+"_"+d+"_onMediaPlayerStateChange";y[n]=function(b){"playing"==b&&J(!1)};h.addEventListener("mediaPlayerStateChange",n);k&&(n=xa+"_"+d+"_onComplete",y[n]=function(){b.trigger("er_next",{noLoop:!0});J(!0)},h.addEventListener("complete",n))}catch(g){}}};var Q=0,Qa="erv"+(p.random()+"").substr(2)+"p";ka=function(h,u,l,p,H){ja("video");var da=u.poster||h,qa=!0===u.autoplay,x=qa&&0==p&&0==H,t=u.src,t=C(t),s=Qa+Q++;d('<div id="'+s+'" style="position:absolute;left:0;right:0;top:0;bottom:0;"></div>').appendTo(l);
var z=!1,B;if(h=t.match(/^https?:\/\/www\.youtube\.com\/watch\?v=([^&]+)/))z=!0,B=h[1];var h=!1,a;(u=t.match(/^https?:\/\/[w\.]{0,4}vimeo\.com\/([\d]+)/))||(u=t.match(/src="https?:\/\/player\.vimeo\.com\/video\/([^"]+)"/));u&&(h=!0,a=u[1]);var c=/iPod|iPhone|iPad|Android/.test(navigator.userAgent),e=!(d.browser.msie&&8>d.browser.version),f=function(a){var b=d('<img width="100" height="100" src="'+N.videoPlayOverlay+'" style="position: absolute; cursor: pointer; left: 50%; top: 50%; margin: -50px 0 0 -50px !important;">');
...
l.width();b=l.height();b='width="'+a+'" height="'+b+'"'}return b},w=function(){var n=s+"f";a.indexOf("?")==-1&&(a=a+"?");var q=x||c?"1":"0";a=/autoplay=[01]/.test(a)?a.replace(/autoplay=[01]/,"autoplay="+q):a+("&autoplay="+q);/portrait=1/.test(a)||(a=a+"&portrait=0");/title=1/.test(a)||(a=a+"&title=0");/byline=1/.test(a)||(a=a+"&byline=0");a=a+("&api=1&player_id="+n);q='<iframe id="'+n+'" src="'+g+"player.vimeo.com/video/"+a+'" '+i(c)+' frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
if(c)f(q);else{l.append(q);q={type:"vimeo",id:n,autoplay:qa};if(e){var h=la(d("#"+n)[0]);h.addEvent("ready",function(){h.addEvent("play",function(){J(false)});h.addEvent("finish",function(){if(k){b.trigger("er_next",{noLoop:true});J(true)}})});q.player=h}r(p,H,q)}};z?function(){var a=s+"f",b=x||c?"1":"0",d="&origin="+g+j.domain;j.domain==""&&(d="");B=/^LIST:/.test(B)?"?listType=playlist&list="+B.substr(5)+"&":B+"?";b=g+"www.youtube.com/embed/"+B+"enablejsapi=1"+d+"&wmode=opaque&autoplay="+b+"&showinfo=0&modestbranding=1&autohide=1&disablekb=1&iv_load_policy=3&rel=0";
b='<iframe id="'+a+'" type="text/html" '+i(c)+' src="'+b+'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';if(c)f(b);else{l.append(b);a={type:"yt",id:a,autoplay:qa};e&&m(a);r(p,H,a)}}():h?w():u()};var X=0,L=0,O=function(){var b=H["r"+X];if(b&&b["c"+L]&&b["c"+L].length)for(var b=b["c"+L],n=0;n<b.length;n++){var h=b[n];try{var g=h.type;"inline"==g?M.getObjectById(h.id).pause():"videoTag"==g?d("#"+h.id)[0].pause():"vimeo"==g?h.player.api("pause"):"yt"==g&&h.player&&
h.player.pauseVideo()}catch(u){y.console&&console.log(u)}}},ea=function(b){O();L=b;if((b=H["r"+X])&&b["c"+L]&&b["c"+L].length)for(var b=b["c"+L],h=0;h<b.length;h++){var g=b[h],u=g.autoplay&&(n.restartAutoplay||!g.hasBeenAutoplayed);try{var j=g.type;"inline"==j&&u?(g.hasBeenAutoplayed=!0,M.getObjectById(g.id).play2(),J(!1)):"videoTag"==j&&u?(g.hasBeenAutoplayed=!0,d("#"+g.id)[0].play(),J(!1)):"vimeo"==j&&u?(g.hasBeenAutoplayed=!0,g.player.api("play"),J(!1)):"yt"==j&&(g.player&&u)&&(g.hasBeenAutoplayed=
!0,g.player.playVideo(),J(!1))}catch(k){y.console&&console.log(k)}}};b.bind("er_setRow",function(b,d){var n=d.id;O();X=n;ea(0)}).bind("er_setCol",function(b,d){ea(d.id)})})();if("BackCompat"==j.compatMode&&d.browser.msie){var V='<a style="color:#FFF;" href="http://www.dwuser.com/easyrotator/doctype/" target="_blank">Error: This page doesn\'t have a valid DocType definition, which makes the rotator fail in IE.  For instructions on how to fix this, click here</a>.';b.css({padding:30,backgroundColor:"#000",
fontFamily:"Georgia,'Times New Roman',Times,_serif",fontSize:16,color:"#FFF",textAlign:"center"}).html(V)}else{var r=function(b,h,g,j,l){b.find(".erimgMain_arrowLeft, .erimgMain_arrowRight").each(function(){var g=d(this),j=g.hasClass("erimgMain_arrowLeft"),l=eval("("+(g.attr("data-erConfig")||"{}")+")"),p=l&&l.image||"circleSmall",Y=l&&l.image2||"circleSmall",da=d.browser.msie&&9>parseInt(d.browser.version);b.bind("at"+(j?0:1),function(b,n){g.stop(!1,!0);var h=n.v;da?g.css({display:n.v?"block":"none"}):
(h&&g.show(),g.fadeTo(300,h?1:0,function(){h||d(this).hide()}))});da?g.css({display:"none"}):g.css({zoom:"1"}).er_alpha(0).hide();p=ua(p,j,!0);Y=ua(Y,j,!1);(new Image).src=p;(new Image).src=Y;var qa=d("<img/>").attr("src",p).css({zoom:"1"}).appendTo(g);g.bind("mouseenter touchstart",function(){qa.attr("src",Y)}).bind("mouseleave touchend touchcancel",function(){qa.attr("src",p)});g.click(function(){b.trigger("ac"+(j?0:1))});if("rollover"==h&&!k){var r=g.children();r.css({display:"none"});da||r.er_alpha(0);
b.bind("mouseenter mouseleave",function(b){r.stop(!1,!0);var n="mouseenter"==b.type;da?r.css({display:n?"inline":"none"}):(n&&r.css({display:"inline"}),r.fadeTo(300,n?1:0,function(){n||d(this).css({display:"none"})}))})}});(function(){var d=!1,h=!1;b.bind("at0 at1",function(b,n){"at0"==b.type?d=n.v:h=n.v});j&&b.iosSwipe({dimension:g?"x":"y",swipe:function(g){d&&!g&&b.trigger("ac0");h&&g&&b.trigger("ac1")},threshold:{x:50,tolerance:0.5},killEvents:!1!==B.killTouchEvents});if(l){var u=function(g){0<
g&&d?b.trigger("ac0"):0>g&&h&&b.trigger("ac1")},k=!1,r=0,t=!1,s,y=!1,v;b.bind("mousewheel",function(b,d,n,h){var d=p.abs(n),j=p.abs(h);if(!g||!(0<d&&j>d))return n=g?0<d?-n:h:h,r+=n,k?y&&!t&&(t=!0,u(r)):(k=!0,r=n,t=!1,clearTimeout(s),y=!1,s=setTimeout(function(){y=!0},50)),clearTimeout(v),v=setTimeout(function(){k=false},250),b.preventDefault(),!1})}})()},z=!1,t=function(){},fa=function(b,h,g){b.addClass("er_elasticPhoto");h=h||b.find("img");d.browser.msie&&h.show();var b=h[0].naturalWidth,k=h[0].naturalHeight,
l=h[0].width,p=h[0].height;0==l&&(0==p&&!isNaN(b)&&!isNaN(k)&&0<b&&0<k)&&(l=b,p=k);225E4<l*p&&(z||(z=!0,""==j.domain&&alert("At least one of the photos in this rotator is quite large (perhaps even a camera original).  Please be sure to use the Image Optimizer on the Tools menu to downsize and optimize your photos.")));h.data("er_origDims",{w:l,h:p,scaleMode:g})},ga=function(b,d){var h=b.width(),g=b.height(),d=d||b.find("img"),j=d.data("er_origDims"),k=j.w,l=j.h,j=j.scaleMode,r=k/l,t=h/g,s=1;if("scaleDown"==
j&&(r>=t&&k>h||r<=t&&l>g)||"scaleUpAndDown"==j||"fillArea"==j)s="fillArea"!=j&&r>=t||"fillArea"==j&&r<=t?h/k:g/l,k*=s,l*=s;P?d.css({left:p.round((h-k)/2),top:p.round((g-l)/2),webkitTransform:"scale("+s+")",webkitTransformOrigin:"0 0"}).show():d.css({left:p.round((h-k)/2),top:p.round((g-l)/2),width:k,height:l}).show()},Ha=function(b){b.find(".er_elasticPhoto").each(function(){ga(d(this))})};d.fn.photoLoading_markNotLoaded=function(){return this.each(function(){d(this).data("erILdMom_done",!1)})};var Ia=
function(b,h){var g=h.find("span.title").html()||"",j=h.find("span.desc").html()||"";b.find(".erimgMain_title").each(function(){var b=d(this);b.html(g.split("ul-fake").join("ul").split("li-fake").join("li"));b.hasClass("erhideWhenEmpty")&&""==b.html()&&(b.hide(),b.closest(".erhideWhenEmptyParent").hide())});b.find(".erimgMain_desc").each(function(){var b=d(this);b.html(j.split("ul-fake").join("ul").split("li-fake").join("li"));b.hasClass("erhideWhenEmpty")&&""==b.html()&&(b.hide(),b.closest(".erhideWhenEmptyParent").hide())});
b.find(".erimgMain_customField").each(function(){var b=d(this),n=b.attr("data-erfield");b.html(h.find("span.customField[data-erfield="+n+"]").html()||"");b.hasClass("erhideWhenEmpty")&&""==b.html()&&(b.hide(),b.closest(".erhideWhenEmptyParent").hide())});""==g&&""==j&&b.find(".erhideWhenNoText").hide()},ha=[],na=",";F&&b.find("[data-ertype=content]").er_randomize();V=b.find("[data-ertype=content]").children("ul").css({position:"absolute",display:"none",left:0,top:0,width:0,height:0});V=b.find("[data-ertype=content]").children("ul");
F=V.children("li").length;if(0==V.length||0==F)alert("No content specified.  Exiting.");else{A&&V.er_randomize();B.addTitleLinks&&V.children("li").each(function(){var b=d(this),h=b.children("a.mainLink");1==h.length&&b.children("span.title").wrapInner(h.clone().empty().addClass("erautoTitleLink"))});b.find("[data-ertype=layout]").find(".erimgMain").each(function(){var h=d(this),g=eval("("+(h.attr("data-erConfig")||"{}")+")"),j=Number(void 0!==g.numTiles?g.numTiles:1);-1==j&&(j=V.first().children().length);
var l=p.min(j,p.max(1,Number(void 0!==g.scrollSize?g.scrollSize:j-1))),y=g.scaleMode||"fillArea",C=g.imgType||"main",H=!0===g.treatAsThumbs,v=Number(void 0!==g.duration?g.duration:600);isNaN(v)&&(v=600);var z=Number(void 0!==g.durationVertical?g.durationVertical:"main"==C?v:300);isNaN(z)&&(z=600);var A=void 0!==g.easing?g.easing:"easeOutQuad",D=!0===g.alwaysPreviousButton,F=!1!==g.loopNextButton,xa=!0===g.jumpCategories,Q=g.arrowButtonMode;/always|rollover/.test(Q)||(Q="always");var P=!1!==g.addMainSlideLinks,
X="rollover"==g.slideLinkEvent&&!k?"mouseenter":"click",L=void 0!==g.infiniteLoop?!1!==g.infiniteLoop:!0===B.pro_infiniteLoop,O=L&&(void 0!==g.infiniteScroll?!0===g.infiniteScroll:!0===B.pro_infiniteScroll),ea=void 0!==g.mouseWheel?!1!==g.mouseWheel:!0===B.pro_mouseWheelAndSwipeEnabled,g=void 0!==g.swipeEnabled?!0===g.swipeEnabled:B.pro_mouseWheelAndSwipeEnabled&&/iPod|iPad|iPhone|Android/i.test(navigator.userAgent);(L||ea||g)&&ja("in the Settings section");var K=h.find(".erimgMain_slides").first();
...
Z*a+'px; left:0;" er_row="'+a+'"></div>').appendTo(K);wa=wa.length==0?f:wa.add(f);var h=c.children("li");if(h.length==0)alert("Empty category being skipped - this may cause problems!");else{ha.push(h.length);var g=function(c,e,f){var h=eval("("+(e.find("span.ervideo").attr("data-erConfig")||"{}")+")");if(h.src&&C=="main"){var g=f.find(".erimgMain_video").first();if(g.length==0){g=f.find(".erimgMain_img").first();g=g.clone().removeClass("erimgMain_img").addClass("erimgMain_video").insertAfter(g)}var n=
e.find("img."+C).attr("src");ka(n,h,g,a,c)}f.find(".erimgMain_img").css({overflow:"hidden"}).each(function(){var a=d(this);a.width();a.height();var b=e.find("img."+C).first().removeAttr("alt");b.attr("ersrc",b.attr("src"));b.attr("src","");b.css({display:"none",position:"absolute"}).attr("border",0).appendTo(a).data("erProcessCount",0).load(function(){var a=d(this);if(!(a.data("erProcessCount")>0||a.attr("src")=="")){a.data("erProcessCount",a.data("erProcessCount")+1);var b=a.closest(".erimgMain_img");
fa(b,a,y);ga(b,a)}}).error(t);(!(C!="main"||H)||!P)&&a.wrapInner(e.find("a."+C+"Link").click(function(){J(false)}));b.addClass("erILdMom")});Ia(f,e);(H||C!="main")&&P&&f.bind(X,function(){var a=d(this);b.trigger("er_setCol",{id:Number(a.closest("[er_col]").attr("er_col"))})})};h.each(function(a){var b=d(this),c=aa.clone().appendTo(f).attr("er_col",a).css({left:E*a,top:0,position:"absolute",width:E,height:Z,overflow:"hidden"}).addClass("er_ssd").data("er_ssd",{left:"slideW*"+a,width:"slideW",height:"slideH"});
g(a,b,c)});f.er_cssWidth(E*h.length).er_cssHeight(Z).er_x(E*h.length).addClass("er_ssd").data("er_ssd",{width:"slideW*"+h.length,height:"slideH",left:"slideW*"+h.length,top:"slideH*"+a});e.er_cssWidth(E*h.length*3).er_cssHeight(1).er_x(0).addClass("er_ssd").data("er_ssd",{width:"slideW*3*"+h.length,top:"slideH*"+a});(function(){var a=h.length;if(L&&a>j)for(var b=0;b<j&&b<a;b++){f.children("[er_col="+(a-1-b)+"]").first().clone(true).appendTo(f).css({left:E*(-b-1)}).addClass("er_ssd").er_cloneDataObject("er_ssd").er_extendDataObject("er_ssd",
...
x.er_x(),b=p.max(0,x.er_cssWidth()-E*j)+a;h.trigger("at0",{v:p.abs(U-a)>9||D});h.trigger("at1",{v:U-b<-9||F})},a=function(a,b){if(l==1){var c=a.er_x(),d=0,e=p.max(0,p.round(x.er_cssWidth()/E)-j)*E,c=p.min(e,p.max(d,c));return x.er_x()+c}var d=0,e=p.max(0,p.round(x.er_cssWidth()/E)-j),f=p.round((U-x.er_x())/E),c=Number(a.attr("er_col"));if(b!==true&&c>=f&&c<f+j)return U;for(;c>=d+j;)d=d+l;d=p.min(e,d);return d*E+x.er_x()},c=function(a,b,c){var d=U,e=U=a,f=x.er_cssWidth(),h=f/E;if(L&&h>j){var g=(a-
x.er_x())/E,n=e;if(g<j&&c!="l"&&(j>1||h>2||c!==void 0))n=a+f;else if(g>=h-j&&c!="r"&&(j>1||h>2||c!==void 0))n=a-f;if(p.abs(n-d)<=p.abs(e-d)||c=="r"&&p.abs(d-x.er_x()-(h-j)*E)<10||c=="l"&&p.abs(d-x.er_x())<10)e=n}b?K.stop().scrollLeft(a):K.stop().animate({scrollLeft:e},v,A,function(){setTimeout(function(){K.stop().scrollLeft(a)},0)});setTimeout(function(){R()},10)},e=function(a,b){G=a;b?K.stop().scrollTop(a):K.stop().animate({scrollTop:a},z,A);setTimeout(function(){R()},10)};setTimeout(function(){c(x.er_x(),
true);e(0,true)},1);var f=ma,m=function(){var b=p.ceil(K.outerWidth()/j),h=p.ceil(K.outerHeight());if(b!=E||h!=Z||f){f=false;E=b;Z=h;K.find(".er_ssd").each(function(){var a=d(this),b=a.data("er_ssd"),c={},e;for(e in b){var f=b[e],f=eval(f.split("slideW").join(E).split("slideH").join(Z));c[e]=f}a.css(c)});Ha(K);b=x.children("[er_col="+M+"]").first();U=a(b,true);G=x.er_y()}setTimeout(function(){c(U,true);e(G,true)},0)};s.push(function(){m()});b.bind("er_setRow",function(a,b){var c=b.id;if(c!=N){wa.filter("[er_row!="+
N+"]").each(function(){var a=d(this),b=Number(a.attr("er_row")),b=S.filter("[er_row="+b+"]");a.er_x(U);b.er_x(U-a.er_cssWidth())});var f=x,h=wa.filter("[er_row="+c+"]");e(h.er_y());N=c;x=h;M=0;f.find(".erimgMain_slide_selected").removeClass("erimgMain_slide_selected");h.find("[er_col=0]").addClass("erimgMain_slide_selected erimgMain_slide_visited")}}).bind("er_setCol",function(b,d){var e=d.id;if(e!=M){var f=x.children("[er_col="+e+"]").first();c(a(f),void 0,d.leftOrRight);M=e;x.find(".erimgMain_slide_selected").removeClass("erimgMain_slide_selected");
f.addClass("erimgMain_slide_selected erimgMain_slide_visited")}});x.children("[er_col=0]").addClass("erimgMain_slide_selected erimgMain_slide_visited");h.bind("ac0 ac1",function(a){a=a.type=="ac0";if(C=="main"&&!H)b.trigger(a?"er_prev":xa?"er_progressNext":"er_next");else{var d=O?1:j,d=p.max(0,p.round(x.er_cssWidth()/E)-d),e=p.round((U-x.er_x())/E),d=a?e==0?d:p.max(0,e-l):e==d?0:p.min(d,e+l);c(d*E+x.er_x(),false,a?"l":"r");J(false)}});r(h,Q,!0,g,ea)}});b.find("[data-ertype=layout]").find(".erthumbGrid").each(function(){var h=
d(this),g=eval("("+(h.attr("data-erConfig")||"{}")+")"),j=g.direction||"horizontal",l=Number(void 0!==g.spacing?g.spacing:10),y=g.scaleMode||"fillArea",C=Number(void 0!==g.duration?g.duration:600);isNaN(C)&&(C=600);var H=Number(void 0!==g.durationVertical?g.durationVertical:"main"==Z?C:300);isNaN(H)&&(H=600);var v=void 0!==g.easing?g.easing:"easeOutQuad",z=!0===g.alwaysPreviousButton,A=!1!==g.loopNextButton,D=g.arrowButtonMode;/always|rollover/.test(D)||(D="always");var F="rollover"==g.slideLinkEvent&&
!k?"mouseenter":"click",J=void 0!==g.mouseWheel?!1!==g.mouseWheel:!0===B.pro_mouseWheelAndSwipeEnabled,g=void 0!==g.swipeEnabled?!0===g.swipeEnabled:B.pro_mouseWheelAndSwipeEnabled&&/iPod|iPad|iPhone|Android/i.test(navigator.userAgent);(J||g)&&ja("in the Settings section");var Q=h.find(".erimgMain_slides").first();Q.css({overflow:"hidden"});var P=Q.find(".erimgMain_slide").css({position:"absolute"}).remove(),X=Q.width(),L=Q.height(),O=0==P.width()?40:P.outerWidth(),ea=0==P.height()?40:P.outerHeight(),
...
x.children("[er_col="+c+"]").first();W||m(f(d),void 0,b.leftOrRight);G=c;x.find(".erimgMain_slide_selected").removeClass("erimgMain_slide_selected");d.addClass("erimgMain_slide_selected erimgMain_slide_visited")}});x.children("[er_col=0]").addClass("erimgMain_slide_selected erimgMain_slide_visited");h.bind("ac0 ac1",function(a){var a="ac0"==a.type,b=p.round(S?x.er_cssWidth()/X:x.er_cssHeight()/L)-1,d=p.round(S?(U-x.er_x())/X:(U-x.er_y())/L),b=a?0==d?b:p.max(0,d-1):d==b?0:p.min(b,d+1),b=S?b*X+x.er_x():
b*L+x.er_y();m(b,!1,a?"l":"r");c()});r(h,D,S,g,J)}});b.find("[data-ertype=layout]").find(".erimgMainOneUp").each(function(){var h=d(this);ja("a Pro template");var g=eval("("+(h.attr("data-erConfig")||"{}")+")"),j=Number(void 0!==g.numTiles?g.numTiles:1);-1==j&&(j=V.first().children().length);var l=g.scaleMode||"fillArea",v=g.imgType||"main",C=Number(void 0!==g.duration?g.duration:600);isNaN(C)&&(C=600);var H=Number(void 0!==g.durationVertical?g.durationVertical:"main"==v?C:300);isNaN(H)&&(H=600);
var y=!0===g.alwaysPreviousButton,z=!1!==g.loopNextButton,A=!0===g.jumpCategories,H=g.arrowButtonMode;/always|rollover/.test(H)||(H="always");var D=!1!==g.addMainSlideLinks,F="rollover"==g.slideLinkEvent&&!k?"mouseenter":"click",N=g.transition||"fade",Q=void 0!==g.mouseWheel?!1!==g.mouseWheel:B.pro_mouseWheelAndSwipeEnabled,M=void 0!==g.swipeEnabled?!0===g.swipeEnabled:B.pro_mouseWheelAndSwipeEnabled&&/iPod|iPad|iPhone|Android/i.test(navigator.userAgent),X=void 0!==g.fadeOutOldSlide?!1!==g.fadeOutOldSlide:
"fillArea"!=l,L=!0===g.crossFade;(Q||M)&&ja("a Pro template");var O=h.find(".erimgMain_slides").first();O.css({overflow:"hidden"});(function(){var a=h.find(".erimgMainOneUp_video");a.length==0&&(a=h.find(".erimgMainOneUp_img"));a.outerWidth();a.outerHeight()})();var ea=h.find(".erimgMainOneUp_img").remove(),K=h.find(".erimgMainOneUp_video").remove();0==K.length&&(K=ea.clone().removeClass("erimgMainOneUp_img").addClass("erimgMainOneUp_video"));K.css({right:"",bottom:"",width:"100%",height:"100%"});
var aa=p.ceil(O.outerWidth()/j),E=p.ceil(O.outerHeight()),Z=[];if(-1!=na.indexOf(","+v))alert("EasyRotator: Layout error. Requested image type ["+v+"] already used.  Display will be ignored.");else{na+=","+v;ha=[];V.each(function(a){var c=d(this).children("li");if(c.length==0)alert("Empty category being skipped - this may cause problems!");else{ha.push(c.length);var e=function(c,e,f){var h=eval("("+(e.find("span.ervideo").attr("data-erConfig")||"{}")+")"),g;if(h.src&&v=="main"){g=K.clone().appendTo(O).er_x("110%");
f.data("erImgAVD",g);var i=e.find("img."+v).attr("src");ka(i,h,g,a,c)}f.css({overflow:"hidden"}).each(function(){var a=d(this);a.width();a.height();var b=e.find("img."+v).first().removeAttr("alt");b.attr("ersrc",b.attr("src"));b.attr("src","");b.css({display:"none",position:"absolute"}).attr("border",0).appendTo(a).data("erProcessCount",0).load(function(){var b=d(this);if(!(b.data("erProcessCount")>0||b.attr("src")=="")){b.data("erProcessCount",b.data("erProcessCount")+1);var c=false;if(f.css("display")==
...
true){a.attr("src",a.attr("ersrc"));a.data("erILdMom_done",true)}})},1)},1)},m=function(){var a=R==Z[S].length-1;h.trigger("at0",{v:R!=0||y});h.trigger("at1",{v:!a||z})},i=function(a){R=a;f();setTimeout(function(){m()},10)};b.bind("er_setRow",function(a,b){var c=b.id;if(c!=S){S=c;i(0)}}).bind("er_setCol",function(a,b){var c=b.id;c!=R&&i(c)});f();setTimeout(function(){m()},10);h.bind("ac0 ac1",function(a){b.trigger(a.type=="ac0"?"er_prev":A?"er_progressNext":"er_next")});r(h,H,!0,M,Q)}});b.find("[data-ertype=layout]").find(".erdynamicText").each(function(){var g=
...
g.find(".erplayPause_btn_play")[h?"hide":"show"]();g.find(".erplayPause_btn_pause")[h?"show":"hide"]()});g.find("a").click(function(d){b.trigger("er_playPauseToggle");d.preventDefault()})});0<b.find(".erpt").length&&ja("a Pro template");(function(){var h={src:"easyrotatorvideo.s3.amazonaws.com/audio/player.swf",srcEI:"easyrotatorvideo.s3.amazonaws.com/1/expressInstall.swf",showController:!0,controllerLocation:"tc",controllerPadding:20,controllerWidth:290,restartAutoplay:!1},k;for(k in h)void 0!==
B["audio_"+k]&&(h[k]=B["audio_"+k]);h.controllerPadding=Number(h.controllerPadding||"20");h.controllerWidth=Number(h.controllerWidth||"290");var l=g;for(k in h)/^src/.test(k)&&(h[k]=l+h[k]);if(""==j.domain&&B.lpp){var r="";(function(){for(var b=B.lpp.split("-"),d=0;d<b.length;d++)r+=String.fromCharCode(b[d])})();for(k in h)/^src/.test(k)&&(l=h[k],l=l.substr(l.lastIndexOf("/")+1),h[k]=r+l)}var t=!0===B.autoplayPauseOnAudio,l={width:h.controllerWidth,loader:"3E9AF9",animation:"no",expressInstall:!1,
transparentpagebg:"yes",enableCallbacks:t};for(k in B)0==k.indexOf("audio_player_")&&(l[k.substr(13)]=B[k]);ia.setup(h.src,l);t&&(y.er_APs||(y.er_APs=[]),y.er_APs.push(function(b){t&&("i"==G&&L==b)&&J(!1)}),y.AudioPlayer={activate:function(b){var d=y.er_APs,g;for(g in d)d[g].call(null,b)}});var s=b.find("[data-ertype=layout]").find(".eraudioController");0==s.length&&(k={position:"absolute",width:h.showController?h.controllerWidth:1,height:h.showController?24:1,overflow:h.showController?"":"hidden"},
k[!h.showController||/^t/i.test(h.controllerLocation)?"top":"bottom"]=h.showController?h.controllerPadding:-100,/c$/.test(h.controllerLocation)?(k.left="50%",k.marginLeft=-p.round(h.controllerWidth/2)):k[/r$/.test(h.controllerLocation)?"right":"left"]=h.controllerPadding,s=d("<div></div>").css(k).appendTo(b.find("[data-ertype=layout]")));var v=/[\d\.]+/.test(s.css("top"))?"top":"bottom",z=s.css(v),A,D=function(b,d){if((h.showController||d)&&b!==A){A=b;var g={};g[v]=b&&h.showController?z:-50;s.stop(true,
true).animate(g,300)}};h.showController||D(!1,!0);var F="erAP_"+(p.random()+"").substr(2)+"_",P=0,N=function(b,d,g,j){if(b){ja("audio");var k=F+P++,l=" onplay=\"AudioPlayer.activate('"+k+"')\"";g&&(l=l+' autoplay="autoplay"');j&&(l=l+' loop="loop"');var l='<audio id="'+k+'a" width="'+h.controllerWidth+'" src="'+b+'" width="'+h.controllerWidth+'" controls="controls"'+l+">No audio support.</audio>",p=ia.determineFlashSupport();s.html('<p id="'+k+'">'+(p?"":l)+"</p>");ia.embed(k,{soundFile:b,titles:d,
autostart:g?"yes":"no",loop:j?"yes":"no"});return k}s.html("")},Q=-1,M=-1,G,L,O=function(d,g,h,j){if(!(d==Q&&g==M)){Q=d;M=g;d=false;if(g=V.eq(Q).children("li:eq("+M+")").find("span.eraudio").attr("data-erConfig"))G="i";else if(h&&(g=V.eq(Q).attr("data-erAudioConfig")))G="g";else if(j&&(g=b.attr("data-erAudioConfig")))G="b";else if(G=="i"||G=="g"&&h||j)d=true;h=eval("("+(g||"{}")+")");if(h.src){D(true);L=N(h.src,h.label||"",h.autoplay!==false,h.loop===true)}else if(d){L=N(null);D(false)}}};b.bind("er_setRow",
...
Ka&&(Ca=!1):"mouseenter"==b.type&&!k?(b=d(b.fromElement),b.hasClass("ercats_btn_internal")&&0==b.parent().length||(Ca=!1,sa&&(J(!1),Ca=!0))):"mouseleave"==b.type&&Ca&&J(!0)})}J(sa);(function(){for(var b=0;b<ca.length;b++)ca[b].css("display","none")})()}}}}});d(y.er_postprocessCallbacks).each(function(){this.call(null,d)})};d(function(){var g=0,h=0;d("div.erAjaxLoad").each(function(){var j=d(this),p=j.attr("data-erajaxsource");p&&(p+="?&nocache="+(new Date).getTime(),g++,d.get(p,function(d,p){d&&"success"==
p?j.replaceWith(d):alert("EasyRotator ajax loading error: "+p);h++;h==g&&G()},"html"))});0==g&&G()})}})(er_$144,document,window,er_swfobject22,er_$f,Math);// JavaScript Document